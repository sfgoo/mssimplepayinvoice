...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('mssimplepayinvoice', MODX_CORE_PATH . 'components/mssimplepayinvoice/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/mssimplepayinvoice/model/schema/mssimplepayinvoice.mysql.schema.xml';
